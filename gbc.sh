...
_lualib() {
	...
	echo "CFLAGS=-Wall -fPIC -O2 -I/usr/include/luajit-2.1 -I_GBC_CORE_ROOT_/bin/openresty_lib/luajit/include/luajit-2.1" >>Makefile
	echo "LDFLAGS=--shared -Wall -fPIC -O2 -L_GBC_CORE_ROOT_/bin/openresty_lib/luajit/lib" >>Makefile
	if [ $OSTYPE == "MACOS" ]; then
